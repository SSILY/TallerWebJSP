...
/**
 * Servlet implementation class ClienteFormHtmlServlet
 */
/**
 * @author Profesor Equipo Comunidad00
 */
@WebServlet(name = "ClienteFormHtml", urlPatterns = { "/ClienteFormHtml" })
public class ClienteFormHtmlServlet extends HttpServlet
{
      ...
      HttpServletResponse response, int key )
  {
    try
    {
      ...
      response.addHeader( "Content-Disposition",
          "attachment;filename=ReporteCliente" + key + ".html" );
